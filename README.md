...
Not addressed in this pass: no specific "this isn't the same" differences were identified to fix, since none were described — if something looks or behaves differently from the recordings this was built from, point to the specific screen and I can take another pass.
